...
#[derive(Debug)]
pub struct StoreDeviceValidated {
    pub name: String,
    pub device_type_id: String,
    pub latitude: Option<f64>,
    pub longitude: Option<f64>,
...
pub fn validate(payload: StoreDevicePayload) -> Result<StoreDeviceValidated, Vec<String>> {
