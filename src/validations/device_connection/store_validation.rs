...
pub struct StoreDeviceConnectionPayload {
...
#[derive(Debug)]
pub struct StoreDeviceConnectionValidated {
    pub from_port_id: String,
    pub to_port_id: String,
    pub details: Value,
}
...
pub fn validate(
    payload: StoreDeviceConnectionPayload,
) -> Result<StoreDeviceConnectionValidated, Vec<String>> {
    ...
    if errors.is_empty() {
        Ok(StoreDeviceConnectionValidated {
