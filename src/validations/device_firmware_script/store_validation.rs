...
pub struct StoreDeviceFirmwareScriptPayload {
    pub name: String,
...
#[derive(Debug)]
pub struct StoreDeviceFirmwareScriptValidated {
    pub name: String,
    pub description: Option<String>,
    pub script_text: String,
...
pub fn validate(payload: StoreDeviceFirmwareScriptPayload) -> Result<StoreDeviceFirmwareScriptValidated, Vec<String>> {
    ...
    if errors.is_empty() {
        Ok(StoreDeviceFirmwareScriptValidated {
            name: safe_name,
