...
fn map_from_port(row: &PgRow) -> Option<DevicePortEntity> {
    match row.try_get::<String, _>("fp_id") {
        Ok(id) => Some(DevicePortEntity {
            ...
            port_interface_id: row.get("fp_port_interface_id"),
...
fn map_to_port(row: &PgRow) -> Option<DevicePortEntity> {
    match row.try_get::<String, _>("tp_id") {
        Ok(id) => Some(DevicePortEntity {
            ...
            port_interface_id: row.get("tp_port_interface_id"),
    ...
    let row = sqlx::query(
        r#"
            SELECT
                ...
                fp.port_interface_id AS fp_port_interface_id,
                ...
                tp.port_interface_id AS tp_port_interface_id,
